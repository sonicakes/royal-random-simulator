          ...
          <div>
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              A pilot project where the actual pilot is Claude Code — Anthropic's AI coding assistant. Film Lady supplies the design and dev briefs; Claude implements and refines.
               Scenarios are also assisted by Claude, keeping the author's vision in mind.
               Scenario images are generated by Gemini AI in the Eastern European Art House Film Poster style 
               (think  <a href="https://filmartgallery.com/collections/walerian-borowczyk-movie-posters">Walerian Borowczyk posters</a> & movie <a href="https://www.imdb.com/title/tt0066516/">Valerie & her week of wonders</a>), 
               using <a className='text-ochre/80 font-bold hover:underline' href="https://github.com/sonicakes/royal-random-simulator/blob/master/public/royal-simulator-image-prompts.md" target='_blank'>highly stylized & customised prompts</a>. Placeholder img by Unsplash.
            </p>
